...
class AirlinePassengers(base.FileDataset):
    ...
    References
    ----------
    [^1]: [International airline passengers: monthly totals in thousands. Jan 49 – Dec 60](https://www.boxjenkins.com/data/international-airline-passengers-monthly-totals-in-thousands-jan-49-dec-60)

...
# Test adding function at the start of the pipeline
...
# Test union functions in pipelines
...
# Test learn_one with learn_during_predict
...
# Test learn_many with learn_during_predict
def test_learn_many_with_learn_during_predict():
    ...
    for i in range(0, len(dataset), 5):
        ...
        y = pd.Series([bool(y % 2) for _, y in dataset][i : i + 5])ar_model, preprocessing

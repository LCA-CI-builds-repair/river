...
- [PyPI](https://pypi.org/project/river/0.4.1- `time_series.Detrender` now has a `window_size` parameter for detrending with a rolling mean. [GitHub](https://github.com/online-ml/river/releases/tag/0.4.1)

...
- Moved all me- Remove unneeded numpy usage for `AdaptiveRandomForest{Classifier,Regressor}`.rics in `metrics.cluster` except `metrics.Silhouette` to [river-extra](https://github.com/online-ml/river-extra).

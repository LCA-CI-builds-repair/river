...
- Added a new base class call# Release Notes for Version 0.6.0

- Add new feature X
- Fix issue Yd `SupervisedTransformer` from which supervised transformers inherit from. Before this, supervised transformers has a `is_supervised` property.
